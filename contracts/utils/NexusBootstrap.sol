...
contract NexusBootstrap is ModuleManager {
    ...
    /// @param registry The registry for the Nexus account.
    /// @param attesters The attesters for the Nexus account.
    /// @param threshold The threshold for the Nexus account.
