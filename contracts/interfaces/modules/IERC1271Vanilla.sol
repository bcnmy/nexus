...
interface IERC1271Vanilla {
    ...
    ///         This vanilla version, should be used in cases when Account is sure that the signed object contains all
    ...
    function isValidSignatureWithSenderVanilla(address sender, bytes32 hash, bytes calldata data) external view returns (bytes4);
}
