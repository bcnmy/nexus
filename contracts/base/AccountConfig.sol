...
/**
 * @title AccountConfig
 * @dev This contract defines Smart Account configuration as per ERC7579
...
abstract contract AccountConfig is IAccountConfig {
    ...
    function supportsExecutionMode(ExecutionMode encodedMode) external view virtual returns (bool);
