...
contract TestFuzz_ERC4337Account is SmartAccountTestLab {
    ...
    function testFuzz_WithdrawDepositTo(address to, uint256 amount) public {
        ...
        PackedUserOperation[] memory depositUserOps = prepareUserOperation(BOB, BOB_ACCOUNT, EXECTYPE_DEFAULT, depositExecutions);
        ...
        PackedUserOperation[] memory withdrawUserOps = prepareUserOperation(BOB, BOB_ACCOUNT, EXECTYPE_DEFAULT, withdrawExecutions);
