...
contract ArbitrumSmartAccountUpgradeTest is NexusTest_Base, ArbitrumSettings {
    ...
    function setUp() public {
        ...
        newImplementation = new Nexus(_ENTRYPOINT, address(DEFAULT_VALIDATOR_MODULE), abi.encodePacked(address(0)));
    ...
    function test_AccountIdValidationAfterUpgrade() public {
        ...
        string memory expectedAccountId = "biconomy.nexus.2.0.0";
